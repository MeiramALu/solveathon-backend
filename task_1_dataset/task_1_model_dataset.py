...
class WaterAISuite:
    ...
    def __init__(self, dry_threshold=30.0, target_humidity=35.0, max_daily_m3_mu=40.0):
        self.model = None
        self.data = None
        self.X_train = None
        self.X_test = None
    ...
    def load_and_process_data(self):
        ...
        try:
            # Load Raw Data
            hum = pd.read_csv("./dataset/CottonSensor/HumiditySensor.csv")
            tem = pd.read_csv("./dataset/CottonSensor/TemSensor.csv")
            weather = pd.read_csv("./dataset/Weather/Weather.csv")
            mgmt = pd.read_csv("./dataset/ManagementInfo.csv")
        except FileNotFoundError:
            print("Error: Missing CSV files. Please ensure files are in the directory.")
            return
        ...
        self.data = df.dropna()
        self.data.to_parquet("daily_dataset.parquet", index=False)
    ...
    def evaluate_and_plot(self):
        ...
        plt.tight_layout()
        plt.savefig("./figures/Plot_1_Feature_Importance.png")
        print("       Saved: Plot_1_Feature_Importance.png")
        ...
        plt.tight_layout()
        plt.savefig("./figures/Plot_2_Actual_vs_Pred.png")
        print("       Saved: Plot_2_Actual_vs_Pred.png")
        ...
        plt.tight_layout()
        plt.savefig("./figures/Plot_3_Residuals.png")
        print("       Saved: Plot_3_Residuals.png")
        ...
        plt.tight_layout()
        plt.savefig("./figures/Plot_4_Digital_Twin.png")
        print("       📷 Saved: Plot_4_Digital_Twin.png")
